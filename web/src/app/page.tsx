  ...
  return (
    <>
      ...
      <PageMain className="home-page">
        ...
        <InfoSection title="为什么这局好玩" eyebrow="ValuePropsSection">
        ...
        <InfoSection title="印刷成果" eyebrow="PrintShowcaseSection">
        ...
        <InfoSection title="怎么玩" eyebrow="HowToPlaySection">
          <div className="steps">
            <p>抽牌，打出妖怪或法宝。</p>
            <p>派妖怪向地盘发动抢地盘。</p>
            <p>守军被清空后占领地盘。</p>
        ...
        <InfoSection title="基础盒内容" eyebrow="BoxContentsSection">
